...
"""
FastAPI application for the Ticket System Environment.

This module creates an HTTP server that exposes the TicketSystemEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m ticket_system.server.app
    ...
    multiple workers:
        uvicorn ticket_system.server.app:app --workers 4
    """
    import uvicorn
...
if __name__ == "__main__":
    ...
    # Validation requires the exact string `main()`
    if False:
        main()
